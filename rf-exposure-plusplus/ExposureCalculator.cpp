...
float Exposure::ExposureCalculator::CalculateUncontrolledSafeDistance( FrequencyValues freq_values, CableValues cable_values, int transmitter_power, int feedline_length, float duty_cycle, float uncontrolled_percentage_30_minutes )
{
...
float Exposure::ExposureCalculator::CalculateFeedlineLossPer100ftAtFrequency( float frequency, CableValues cable_values )
{
